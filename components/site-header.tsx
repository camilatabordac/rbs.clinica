    ...
    >
      <div className="container flex items-center justify-between">
        ...
        <nav className="hidden md:flex gap-8">
          <a href="#quem-somos" className="text-base font-bold text-gray-700 hover:text-[#55bbad] transition-colors">
            Quem Somos
          </a>
          <a href="#servicos" className="text-base font-bold text-gray-700 hover:text-[#55bbad] transition-colors">
            Serviços
          </a>
          <a href="#especialistas" className="text-base font-bold text-gray-700 hover:text-[#55bbad] transition-colors">
            Especialistas
          </a>
          <a href="#depoimentos" className="text-base font-bold text-gray-700 hover:text-[#55bbad] transition-colors">
            Depoimentos
          </a>
          <a href="#localizacao" className="text-base font-bold text-gray-700 hover:text-[#55bbad] transition-colors">
            Localização
          </a>
        </nav>
